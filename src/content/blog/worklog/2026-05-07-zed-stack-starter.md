...
subtitle: "A full-stack React starter with React 19, TanStack Router, Hono, better-auth, Drizzle and ZUI on Cloudflare Workers, so I stop reassembling the same pieces."
date: 2026-05-07
worklog: true
---

Put together [zed-stack-starter](https://github.com/mrmartineau/zed-stack-starter), a modern full-stack React starter so I can stop reassembling the same pieces every time I start something new. It's React 19 with [TanStack Router](https://tanstack.com/router), a [Hono](https://hono.dev) API, [better-auth](https://www.better-auth.com), [Drizzle ORM](https://orm.drizzle.team) on Postgres, and [ZUI](https://github.com/mrmartineau/zui) for the UI, all deployed to Cloudflare Workers. It's since become the centrepiece of [the Zed Stack](/zed-stack).
