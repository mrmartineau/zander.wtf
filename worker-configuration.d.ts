/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5ca4076004d6977f353d9ae0a1e19908)
// Runtime types generated with workerd@1.20260124.0 2026-01-20 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NOTION_TOKEN: string;
		LASTFM_API_KEY: string;
		OTTER_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NOTION_TOKEN" | "LASTFM_API_KEY" | "OTTER_API_KEY" | "SUPABASE_USER_ID">> {}
}
